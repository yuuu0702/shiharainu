...
class _$PaymentModelImpl implements _PaymentModel {
  ...
  @override
  String toString() {
    return 'PaymentModel(id: $id, eventId: $eventId, userId: $userId, amount: $amount, status: $status, paymentMethod: $paymentMethod, transactionId: $transactionId, paidAt: $paidAt, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, eventId, userId, amount,
      status, paymentMethod, transactionId, paidAt, createdAt, updatedAt);
